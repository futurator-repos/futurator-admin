...
export function buildTwoFrameJudgePrompt({ spec, sourceDiff, beforeFrame, afterFrame }) {
  ...
  return [
    ...
    '2. PASS — frame 2 observably shows the expected change from frame 1.',
    '3. FAIL — the frames contradict the expected change; cite the concrete contradicting',
    '   observation. conf=high only when unambiguous.',
    '4. UNCERTAIN — unreadable images or genuinely too close to call.',
    '',
