...
import { useEc2Status, useEnableEc2, useDisableEc2 } from '@/hooks/use-ec2-daemon';
...
function MonitorContent() {
  ...
  const isTransitioning = isPending || isStopping || enableEc2.isPending || disableEc2.isPending;
