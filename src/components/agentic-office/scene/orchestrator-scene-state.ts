import type { OrchestratorAnimationIntent, SupervisorStatus } from '../event-translator';
...
export function applyOrchestratorIntent(
  ...
  switch (intent.type) {
    ...
    case 'touch_points_update':
      // Visual-only; no persistent scene state change.
      return state;
    ...
    case 'blocker_card_remove': {
      ...
      // Also clear blocked flag on the desk.
