    ...
    <div className="border-t" style={{ borderColor: COLORS.bgDeepest }}>
      ...
      <div className="space-y-1.5 px-3 pb-3">
        ...
        {!isLoading && questions.length === 0 && (
          ...
          >
            Highlight any text in a chat bubble and click <strong>Ask a question</strong> to store
            quick clarifications here.
          </div>
        )}
        {questions.map((q) => {
          ...
          return (
            ...
            >
              <button
                ...
                className="party-hover-tint block w-full px-2.5 py-2 text-left transition-colors"
              ...
              >
                ...
                <div
                  className="party-snippet-tint mt-1 line-clamp-1 rounded px-1.5 py-0.5 font-mono text-[10px] italic"
                  style={{ color: COLORS.textMuted }}
                  title={q.anchor.snippet}
                >
                  &ldquo;{q.anchor.snippet.slice(0, 80)}
                  {q.anchor.snippet.length > 80 ? '…' : ''}&rdquo;
                </div>
                <div
              ...
              <button
                ...
                className="party-hover-tint flex w-full items-center justify-center gap-1 border-t py-0.5 text-[10px] font-mono uppercase tracking-wider"
                style={{
