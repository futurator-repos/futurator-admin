...
| **Generative / non-deterministic** | chat: "AI replies to my message"                               | behavior              | L2-state **structural** ("assistant msg appended within Ns", `count+1`); judged = on-topic. **Exact-match oracle FORBIDDEN.**                                                                   | PRD rule (below)                             |
